  ...
  return (
    <section className="container mx-auto mt-20">
      <div className="flex justify-center">
        <div className="max-w-[620px] max-h-[350px] px-6 py-8 bg-primary-color rounded-l-lg flex flex-col gap-6">
          <h3 className="font-thin text-2xl text-white">
            Yemek ve market ihtiyaçlarının tamamı için hemen indir!
          </h3>
          <div className="flex gap-6">
            <img
              className="max-w-[100px] h-[90px] border rounded-md p-2"
          ...
          <div className="flex gap-6 mt-4">
            <a href="#" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="133" height="40">
                <g fill="none">
                  <path
                    fill="#B6B6B6"
            ...
            <a
              href="https://utsh.adj.st/?adj_t=12e25dhg&amp;adj_deep_link=yemeksepeti%3A%2F%2F%3F&amp;adj_campaign=tr_homepage_android&amp;wssid=1709164184863.897858280283956100.3u0u5yjotb"
              target="_blank"
              class="play-store"
            ...
            <a
              href="https://utsh.adj.st/?adj_t=12d0wowa&amp;adj_deep_link=yemeksepeti%3A%2F%2F%3F&amp;adj_campaign=tr_homepage_ios&amp;wssid=1709164184863.897858280283956100.3u0u5yjotb"
              target="_blank"
              class="apple-store"
        ...
        <div className="max-w-[620px] max-h-[350px] bg-primary-color flex items-center rounded-r-lg">
          <img
            src="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2000&height=1590"
            alt=""
            className="w-[520px] h-[480px]"
          />
        </div>
      </div>
    </section>
